...
jQuery(document).ready(function(){
	...
	$('input[name^=namaobat]').autocomplete({	
		...
		{	
			...
			this.form.tersedia.value = ui.item.stokakhir;
			...
			this.form.kadaluarsa.value = ui.item.kadaluarsa;


			var coba = this.form.kadaluarsa.value;
			var tglExp = new Date(coba);
			...
			if(tglExp > today ){
			  alert("Obat ini masih aman belum Exipired dan Tanggal expired adalah "+ coba);
			}else{
			  alert("Obat ini sudah Exipired dan Tanggal expired adalah "+ coba);
			}
...
<td><input type="text" readonly="readonly" data-validation="date" data-validation-format="yyyy-mm-dd" id="datepicker3" class="input-small" name="kadaluarsa" /></td>
