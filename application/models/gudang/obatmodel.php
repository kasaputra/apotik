...
class Obatmodel extends CI_Model {
	...
	function getObat()
	{
		...
		$limit=10;
		$offset = ($page - 1) * $limit;
		$sql="SELECT obat.id_obat, obat.nama_obat, kategori_obat.nama_kategori, satuan_obat.nama_satuan, obat.stok_akhir, obat.harga_beli, obat.harga_jual, obat.tipe_apotik,obat.min_order,obat.kadaluarsa FROM
		...
		limit $offset,$limit";
		$sql2="SELECT obat.id_obat, obat.nama_obat, kategori_obat.nama_kategori, satuan_obat.nama_satuan, obat.stok_akhir, obat.harga_beli, obat.harga_jual, obat.tipe_apotik,obat.min_order,obat.kadaluarsa FROM
		(obat LEFT JOIN kategori_obat ON obat.id_kategori_obat = kategori_obat.id_kategori_obat) LEFT JOIN satuan_obat ON obat.id_satuan_obat = satuan_obat.id_satuan_obat
		$where AND obat.id_obat !=''";
	...
	function getObatkd()
	{
		...
		$limit=10;
		$offset = ($page - 1) * $limit;
		$sql="SELECT DATE_FORMAT(kadaluarsa, '%d %M %Y') AS tgl, obat.id_obat, obat.nama_obat, kategori_obat.nama_kategori, satuan_obat.nama_satuan, obat.stok_akhir, obat.harga_beli, obat.harga_jual, obat.tipe_apotik,obat.min_order FROM
		(obat LEFT JOIN kategori_obat ON obat.id_kategori_obat = kategori_obat.id_kategori_obat) LEFT JOIN satuan_obat ON obat.id_satuan_obat = satuan_obat.id_satuan_obat
		ORDER BY kadaluarsa ASC";
		$sql2="SELECT DATE_FORMAT(kadaluarsa, '%d %M %Y') AS tgl, obat.id_obat, obat.nama_obat, kategori_obat.nama_kategori, satuan_obat.nama_satuan, obat.stok_akhir, obat.harga_beli, obat.harga_jual, obat.tipe_apotik,obat.min_order FROM
		(obat LEFT JOIN kategori_obat ON obat.id_kategori_obat = kategori_obat.id_kategori_obat) LEFT JOIN satuan_obat ON obat.id_satuan_obat = satuan_obat.id_satuan_obat
		ORDER BY kadaluarsa ASC";
		$datas=$this->database_library->QueryData($sql);;
		$TR=$this->database_library->QueryNumRow($sql2);
